...
const NewPlaylist = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, actions) => {
      try {
        // Make sure the token is properly sent in the Authorization header
        ...
        if (error.response) {
          // If the error has a response (e.g., validation errors from backend)
          toast.error(
    ...
    validationSchema: createPlaylistSchema, // Validation schema
  });
